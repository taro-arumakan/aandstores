(String.prototype.parse = function (t) {
  ...
  (Element.prototype.setStyles = function (t = {}) {
    for (const e in t) this.style[e] = t[e];
    return this;
  }),
...
class SizeQueries {
  ...
  static instances = {};
  static init(t = window) {
    new ResizeObserver(() => SizeQueries.updateScreenSize(t)).observe(
      t === window ? document.body : t
    );
  }
  static updateScreenSize(t) {
    var e = SizeQueries.instances[t],
      i = t === window ? window.innerWidth : t.clientWidth;
    i >= SizeQueries.large_screen
      ? (SizeQueries.instances[t] = "large")
      : i >= SizeQueries.medium_screen
      ? (SizeQueries.instances[t] = "medium")
      : (SizeQueries.instances[t] = "small"),
      SizeQueries.instances[t] !== e && t.trigger("theme:mqs:updated");
  }
}
class Utils {
  ...
  static getFocusableEl(e = !1) {
    if (e) {
      let t = "";
      "small" === SizeQueries.instances[window]
        ? (t =
            ":not([data-mq='medium-large']):not([data-mq='medium']):not([data-mq='large'])")
        : "medium" === SizeQueries.instances[window]
        ? (t = ":not([data-mq='small']):not([data-mq='large'])")
        : "large" === SizeQueries.instances[window] &&
          (t =
  ...
  static updateRecentProducts(t) {
    ...
    let r,
      ...
      a = !1;
    s
      ? -1 === (r = JSON.parse(s)).indexOf(t) && (a = !0)
      : ((o = JSON.stringify(i)), localStorage.setItem(e, o)),
      a &&
        (4 === r.length && (r = r.slice(1)),
        (o = JSON.stringify(r.concat(i))),
...
class Transitions {
  ...
  static load(t = !1) {
    var e, i;
    t
      ? ((e = t.getAttribute("data-transition-container")),
        (Transitions.instances[e] = new Transitions(t)))
      : ((i = [...document.querySelectorAll("[data-transition-container]")]),
        (Transitions.instances = i.map((t) => new Transitions(t))));
  }
  static reload(e) {
    Transitions.instances.forEach((t) => e === t.name && t.initItems());
  }
  static reset(e) {
    Transitions.instances.forEach((t) => {
      e === t.name &&
        t.items.forEach((t) => t.setAttribute("data-transition-active", !1));
    });
  }
  constructor(t) {
    (this.container = t),
      (this.name = this.container.getAttribute("data-transition-container")),
      "" !== this.name && (this.initItems(), this.itemsListener());
  }
  initItems() {
  ...
  configureItem(t, e) {
    var i,
      ...
      r = s || this.cascade,
      o = t.getAttribute("data-transition-cascade-interval"),
      a = o ? parseInt(o) : this.interval,
      n = t.getAttribute("data-transition-trigger"),
      l = n || this.trigger;
    r && this.addItemCascade(e, r, a),
      (null !== l && isNaN(parseInt(l))) ||
        ((i =
          null !== this.items[e].getAttribute("data-transition-reset") ||
          this.reset),
        this.addItemObserver(e, i, null === l ? 0.4 : parseInt(l) / 100));
  }
  addItemCascade(t, e, i) {
    ...
    "horizontal" === e
      ? ((s = this.items[t].offsetTop),
        ...
        (o.style.transitionDelay = this.column_counter * i + "ms"))
      : "vertical" === e && (o.style.transitionDelay = t * i + "ms");
  }
  addItemObserver(t, i, e) {
    new IntersectionObserver(
        ...
        e && this.cascade
          ? this.items.forEach((t) => {
              t.setAttribute("data-transition-active", !0),
                t.on(
                  "transitionend",
                  () => t.setAttribute("data-transition-finished", !0),
                  { once: !0 }
                );
            })
          : e
      ...
      { threshold: e }
    ).observe(this.items[t]);
  }
  itemsListener() {
    window.on("theme:mqs:updated", () => this.initItems());
  }
}
class Drawer extends HTMLElement {
  ...
  connectedCallback() {
    ((Drawer.instance = this).close_button = document.querySelector(
  ...
  closing() {
    this.overlay.setAttribute("aria-hidden", !0),
      ...
      Transitions.reset(this.state.view);
  }
  closed() {
  ...
  static open(t, e, i) {
    Drawer.instance && Drawer.instance.open(t, e, i);
  }
  static close() {
    Drawer.instance && Drawer.instance.close();
  }
  static loadTriggers() {
    Drawer.instance && Drawer.instance.loadTriggers();
  }
}
...
class Cart extends HTMLElement {
  ...
  connectedCallback() {
    ((Cart.instances[this.dataset.view] = this).abort_controllers = {}),
  ...
  toggleLoadingOnSubmit() {
    this.checkout_button.on("click", () =>
      this.checkout_button.setAttribute("data-loading", !0)
    );
  }
  noteTypingListener() {
    this.note.on("input", () => {
      this.updateNote(this.note.value),
        Object.values(Cart.instances).forEach(
          (t) => (t.note.value = this.note.value)
        );
    });
  }
  async updateNote(t) {
  ...
  renderDynamicCheckoutButtons() {
    ...
    window.location.pathname === Shopify.routes.cart &&
      ((t = document.querySelector(
        ".drawer--root .cart--additional-buttons"
      )) && t.remove(),
      "small" === SizeQueries.instances[window]) &&
      (e = document.querySelector(
        '.drawer--root [data-view="desktop"] .cart--additional-buttons'
      )) &&
      e.remove();
  }
  toggleLoadingDisplay(t, e) {
    ...
    !t &&
      ...
      this.dynamic_checkout_buttons &&
        this.dynamic_checkout_buttons.setAttribute("data-disabled", !t);
  }
  ...
  async updateQuantity(t, e) {
    ...
    var i = this.querySelector(`.cart--item[data-line-num='${t}']`),
      { management: s, policy: r, quantity: o } = i.dataset,
      a = parseInt(o),
      n = i.getAttribute("data-variant-id"),
      l = this.getOtherVariantQuantities(i, n),
      h = a < e + l && "shopify" === s && "continue" !== r;
    h && (e = a - l);
    try {
      var c,
        d = await fetch(Shopify.routes.cart_change + ".js", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            line: t,
      ...
      if (d.ok)
        return (
          Cart.fetchTotals(),
          (c = (await d.json())["sections"]),
          Cart.updateAllHtml(c),
          !h
        );
  ...
  static updateAllHtml(t, s) {
    Object.entries(t).forEach(([t, e]) => {
      var i = Cart.instances[t.replace(/^cart-/, "")];
      i &&
        (i.swapInNewContent(e.parse(".cart--form")),
        i.toggleLoadingDisplay(!0),
        Transitions.reload("cart-" + i.dataset.view),
        s && Transitions.reset("cart-" + i.dataset.view),
        window.trigger("theme:cart:updated", i));
    });
  }
  swapInNewContent(t) {
  ...
  static async addItems(t = {}, ...e) {
    var i = await fetch(Shopify.routes.cart_add + ".js", t);
    if (!i.ok) throw new Error(i.statusText);
    Cart.fetchTotals();
    var s = (await i.json())["sections"];
    Cart.updateAllHtml(s, !0),
      e.forEach((t) => window.trigger("theme:cart:productAdded", t));
  }
  static async fetchTotals(t = !1) {
    var e = await fetch(Shopify.routes.cart + ".js");
    if (!e.ok) throw new Error(e.statusText);
    var { items: i, item_count: s } = await e.json();
    Cart.fillBasket(i), t || Cart.updateTotals(s);
  }
  static fillBasket(t) {
    (Cart.basket = {}),
      t.forEach(({ id: t, quantity: e }) => (Cart.basket[t] = e));
  }
  static updateTotals(i) {
    document
      .querySelector("[data-cart-count]")
      .setAttribute("data-cart-count", i),
      Object.values(Cart.instances).map((t, e) => {
        t.setAttribute("data-has-items", 0 < i),
          0 === i && ((t.note.value = ""), 0 === e) && t.updateNote("");
      });
  }
}
...
class Modal extends HTMLElement {
  ...
  constructor() {
    super(),
      ...
      ((Modal.instances[this.dataset.id] = this).blocking =
        null !== this.dataset.blocking && this.dataset.blocking),
      this.blocking &&
  ...
  addListeners() {
    (this.next_buttons.length ? this.next_buttons : Modal.next_button).on(
      ...
      ).on(`click.${this.dataset.id}-modal`, () => this.toggleView("previous")),
      this.blocking ||
        (window.on(`keydown.${this.dataset.id}-modal`, ({ key: t }) => {
          var e = 1 < this.views.length && !this.blocking;
          "Escape" === t
            ? this.close()
            : "ArrowLeft" === t
  ...
  close() {
    "closed" === Modal.status ||
      this.state.view_disabled ||
      (Modal.viewport.removeAttribute("style"),
            ...
            this.state.active_view.on(
              ...
              () => {
                this.state.active_view.setAttribute(
                  ...
                  (this.state.view_disabled = !1);
              },
              { once: !0 }
            ),
            (this.state.view_disabled = !0),
...
class ModalTrigger extends HTMLElement {
  ...
  connectedCallback() {
    const i = parseInt(this.getAttribute("data-delay")),
      s = parseInt(this.getAttribute("data-index"));
    this.on(
      `click.${this.dataset.id}-modal-trigger keydown.${this.dataset.id}-modal-trigger`,
      (t) => {
        const e = Modal.instances[this.dataset.id];
        ("keydown" === t.type && "Enter" !== t.key) ||
          (isNaN(s) || e.toggleView(s, !1),
          "closed" !== Drawer.status && Drawer.close(),
          isNaN(i) ? e.open(this) : setTimeout(() => e.open(this), i));
      }
    );
  }
  disconnectedCallback() {
...
class FeedbackBar extends HTMLElement {
  ...
  connectedCallback() {
    ((FeedbackBar.instance = this).message_container = this.querySelector(
  ...
  open() {
    this.setAttribute("aria-hidden", !1),
      setTimeout(() => this.setAttribute("data-transition-active", !0), 5),
  ...
  static trigger(t, e) {
    FeedbackBar.instance && FeedbackBar.instance.trigger(t, e);
  }
  static load(t = !1) {
    FeedbackBar.instance && FeedbackBar.instance.load(t);
  }
}
...
class QuickAdd extends HTMLElement {
  ...
  connectedCallback() {
    (this.button = this.querySelector(".product-quick-add--button")),
      ...
      (this.query =
        "?section_id=product-quick-add--form&variant=" + this.dataset.id),
      this.button.on("click", async (t) => {
        t.preventDefault(),
          this.setAttribute("aria-busy", !0),
          "true" === this.dataset.form
            ? await this.showForm()
  ...
  async showForm() {
    let e = !0;
    if (
      (Object.keys(QuickAdd.forms).forEach((t) => {
        (QuickAdd.forms[t].style.display =
          t === this.handle ? "block" : "none"),
          t === this.handle && (e = !1);
      }),
      e)
    ) {
      ...
      if (!t.ok)
        throw (this.setAttribute("data-loading", !1), new Error(t.status));
      var i = (await t.text()).parse(".product-quick-add--form");
      (QuickAdd.forms[this.handle] = i),
        document
          .querySelector('.drawer--container[data-view="product-form"]')
          .appendChild(i);
    }
  ...
  async addToCart() {
    if (Utils.getQuantity(this.dataset.id, this.dataset, 1)) {
      var t = {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          items: [{ id: this.dataset.id, quantity: 1 }],
          sections: Cart.sections,
        }),
      };
      try {
        await Cart.addItems(t, this.dataset.id),
          Drawer.open("right", "cart-drawer", this.button);
      } catch (t) {
        throw (this.setAttribute("data-loading", !1), new Error(t));
      }
    }
  }
  static clearFormListeners() {
    window.on("theme:navigation:reloaded theme:search:reloaded", () => {
      Object.keys(QuickAdd.forms).forEach((t) => QuickAdd.forms[t].remove()),
        (QuickAdd.forms = {});
    });
  }
}
...
class General {
  constructor() {
    console.info(
      `%cBlockshop theme v10.2.0 by Troop Themes - Learn about our JS API here:
https://support.troopthemes.com/guide/api-for-custom-code?utm_source=console&utm_medium=console`,
      ...
      Transitions.load(),
      Cart.fetchTotals(!0),
      QuickAdd.clearFormListeners(),
      SizeQueries.init(),
      this.setSwipeConfig(),
      "loading" === document.readyState
        ? document.on("DOMContentLoaded", () => this.load())
        : this.load();
  }
  load() {
    this.configureLinks(), this.addPrefetchListeners(), this.observeMutations();
  }
  setSwipeConfig() {
    Utils.scriptLoader(
      "swipe_listener",
  ...
  addPrefetchListeners() {
    ...
    t.length &&
      (t.off("mouseover.General"),
      t.on("mouseover.General", ({ target: t }) => {
        var e = t.href ? t : t.closest("a[href]");
        e && Utils.linkLoader(e.href, "prefetch", "high", "document");
      }));
  }
  observeMutations() {
    new MutationObserver(() => {
      this.addPrefetchListeners(), this.configureLinks();
...
class Popup extends HTMLElement {
  ...
  addObserver() {
    var t = document.querySelector(".layout--main-content").lastElementChild;
    t &&
...
class TabOrder {
  constructor(t = !1, e = !1) {
    (this.mobile_order_elements = this.getElementList(t)),
      (this.desktop_order_elements = this.getElementList(e)),
      (this.tabbing = !1),
      this.detectTabbing(),
  ...
  detectTabbing() {
    window.off("click.TabOrder, keydown.TabOrder"),
      window.on("click.TabOrder", () => (this.tabbing = !1)),
      window.on("keydown.TabOrder", (t) => {
        9 === t.which && (this.tabbing = !0);
      }),
      document.on("keydown", (t) => {
        (this.tab_forwards = !0),
          "Tab" === t.key && t.shiftKey && (this.tab_forwards = !1);
      });
  }
  getElementList(t) {
    if (t) {
  ...
  updateOrderList() {
    "small" === SizeQueries.instances[window]
      ? ((this.current_order_elements = this.mobile_order_elements),
        (this.previous_order_elements = this.desktop_order_elements))
      : ((this.current_order_elements = this.desktop_order_elements),
        (this.previous_order_elements = this.mobile_order_elements));
  }
  focusListener() {
    this.current_order_elements &&
      this.current_order_elements.on("focusout", (t) =>
        this.focusOutCallback(t.target, t.target.index(), t)
      );
  }
  focusOutCallback(t, e, i) {
    var s;
    this.tabbing &&
      ((s = !t.contains(i.relatedTarget) && "closed" === Drawer.status) &&
      this.tab_forwards
        ? this.moveFocus(e + 1, "forwards")
        : s && this.moveFocus(e - 1, "backwards"));
  }
  moveFocus(t, e) {
    var i = this.current_order_elements[t],
      s = Utils.getFocusableEl(i);
    t < this.current_order_elements.length &&
      "forwards" === e &&
      (s
        ? s[0].focus()
        : t + 1 < this.current_order_elements.length &&
          this.moveFocus(t + 1, "forwards")),
      0 <= t &&
        "backwards" === e &&
        (s
          ? s[s.length - 1].focus()
          : 0 <= t - 1 && this.moveFocus(t - 1, "backwards"));
  }
  disableFocus() {
    this.previous_order_elements &&
      this.previous_order_elements.off("focusout");
  }
  resizeListener() {
    window.on("theme:mqs:updated", () => {
      this.updateOrderList(), this.focusListener(), this.disableFocus();
    });
  }
}
class Carousel extends HTMLElement {
  ...
  connectedCallback() {
    (this.blocks = this.querySelectorAll(".carousel--block")),
      ...
      (this.dot_svg = this.querySelector(":scope > script").innerText),
      ...
      SizeQueries.init(this),
      Shopify.designMode && this.load(),
  ...
  load() {
    this.initNewScreenSize(),
      this.updateActive(),
      ("small" !== SizeQueries.instances[this] && this.mobile_only) ||
      1 === this.slide_count
        ? this.removeListeners()
  ...
  initNewScreenSize() {
    if ("small" === SizeQueries.instances[this]) {
      if ("small" === this.loaded_size) return;
      this.dot_nav_enabled && this.dot_nav.setAttribute("data-loaded", !1),
      ...
      if ("medium-large" === this.loaded_size) return;
    ...
    (this.dot_change_type = "init"),
      (this.slide_count = Math.ceil(
        this.blocks.length / this.blocks_per_slide
      )),
      this.createDotNav(),
  ...
  updateContainerDestination() {
    (this.container_destination =
      ((this.active_slide - 1) / this.slide_count) * -100 + "%"),
      this.style.setProperty("--slide-pos", this.container_destination);
  }
  slideToNext(t = !1, e = !1) {
    ...
    return (
      this.active_slide !== this.slide_count
        ? (this.updateActive("next", e), (i = "forwards"))
        : t && this.active_slide === this.slide_count
        ? ((this.active_slide = 1), this.updateActive(!1, e), (i = "forwards"))
  ...
  goToActiveSlide(t = !1, e = "forwards") {
    this.active_blocks &&
      this.active_blocks.forEach((t) => Transitions.reload(t.dataset.id)),
      ...
      this.old_active_blocks &&
        this.old_active_blocks.forEach((t) => Transitions.reset(t.dataset.id));
  }
  checkStartEnd() {
  ...
  updateActive(t = !1) {
    "next" === t
      ? ((this.active_slide += 1),
        this.prev && !this.auto_rotate && this.prev.focus())
      : "prev" === t &&
        (--this.active_slide, this.next) &&
        !this.auto_rotate &&
        this.next.focus(),
      this.active_blocks && (this.old_active_blocks = this.active_blocks);
    var e = (this.active_slide - 1) * this.blocks_per_slide,
      i = e + this.blocks_per_slide;
    (this.active_blocks = [...this.blocks].slice(e, i)),
  ...
  updateArrowPos() {
    ...
    this.prev &&
      this.next &&
      ([this.prev, this.next].forEach((t) => t.setAttribute("aria-hidden", !1)),
      (t = this.active_blocks.map((t) => {
        return (
          t.querySelector("img, .placeholder--root, svg").offsetHeight || 0
        );
      })),
      this.style.setProperty("--max-image-height", Math.max(...t) + "px"));
  }
  swipeListener() {
  ...
  createDotNav() {
    if (
      this.dot_nav_enabled &&
      this.dot_nav &&
      (!this.dot_nav || ((this.dot_nav.innerHTML = ""), 1 !== this.slide_count))
    ) {
      let t = "";
      for (let e = 0; e < this.slide_count; e++)
        t += `<button class="carousel--dot" aria-label="${e}">${this.dot_svg}</button>`;
      (this.dot_nav.innerHTML = t),
        (this.dots = this.dot_nav.querySelectorAll(".carousel--dot")),
        this.dots &&
          (this.dotNavListeners(), 5 < this.dots.length) &&
          this.dotTransitionListener();
    }
  }
  dotNavListeners() {
    ...
    this.dots.off("transitionend"),
      this.dots.on("transitionend", ({ target: t }) => {
        t.parentNode === this.dots[this.active_slide - 1] &&
          this.style.setProperty("--dot-pos", this.dot_offset + "px");
      });
  }
  updateActiveDot() {
    this.dot_nav_enabled &&
      ...
      this.dots[this.active_slide - 1] && 5 < this.dots.length
        ...
        : this.dot_nav_enabled && this.dot_nav.setAttribute("data-loaded", !0));
  }
  updateTrailingLeadingDots() {
    ...
    this.active_slide === this.leading_dot_index
      ...
      ? (this.leading_dot_index--,
        ...
        "init" === this.dot_change_type &&
          this.dot_nav.setAttribute("data-loaded", !0))
      : "init" === this.dot_change_type || "hidden" === i
  ...
  moveDots(t) {
    this.dot_nav &&
      ...
      "small" !== this.loaded_size
        ...
        : t || this.style.setProperty("--dot-pos", this.dot_offset + "px"));
  }
  arrowNavListeners() {
    this.prev &&
      (this.prev.off("click." + this.section_id),
      this.prev.on("click." + this.section_id, () => {
        this.slideToPrev(),
          this.setSliderHeight(),
          this.updateArrowPos(),
          this.updateActiveDot();
      ...
      this.next &&
        (this.next.off("click." + this.section_id),
        this.next.on("click." + this.section_id, () => {
          this.slideToNext(),
            this.setSliderHeight(),
            this.updateArrowPos(),
            this.updateActiveDot();
  ...
  removeListeners() {
    this.blocks.off("shopify:block:select." + this.section_id),
      ...
      window.off(
        `theme:swipe:left.${this.section_id} theme:swipe:right.` +
          this.section_id
      );
  }
}
...
class Announcement extends HTMLElement {
  ...
  connectedCallback() {
    (this.blocks = this.querySelectorAll(".announcement--block")),
      ...
      Shopify.designMode && 1 < this.blocks.length && this.editorListeners();
  }
  getActiveBlocks() {
    (this.active_blocks = []),
  ...
  isBlockActive(t) {
    return (
      ("small" === SizeQueries.instances[window] && "small" === t.dataset.mq) ||
      ("medium" === SizeQueries.instances[window] &&
        "medium-large" === t.dataset.mq) ||
      ("large" === SizeQueries.instances[window] &&
        "medium-large" === t.dataset.mq) ||
  ...
  updateBlocks() {
    const e = this.active_blocks[this.next_index],
...
class CountdownTimer extends HTMLElement {
  ...
  initDate(t, e, i, s, r) {
    ...
    return (
      Utils.areNumericStrings(t, e, i)
        ? (o = new Date(Date.UTC(i, e - 1, t, s, r)))
        : ((o = new Date()).setHours(0, 0, 0, 0), o.setDate(o.getDate() + 1)),
      o.getTime()
    );
  }
  addStateListener() {
    this.digits.on("transitionend", ({ target: t }) => {
      "slide-out" === t.getAttribute("data-transition-type") &&
        t.removeAttribute("data-transition-type");
    });
  }
  initTimer() {
  ...
  checkIfFinished() {
    if (0 < this.distance) return !1;
    clearInterval(this.timer);
    var t,
      e = this.closest("[data-countdown-container]");
    return (
      e &&
        (this.hide_when_expired && (e.style.display = "none"),
        (t = e.querySelector("[data-countdown-button]")) &&
...
class Disclosure extends HTMLElement {
  ...
  connectedCallback() {
    (this.viewport = this.closest(".drawer--side, .layout--main-content")),
      Disclosure.instances.push(this),
      "loading" === document.readyState
        ? window.on("DOMContentLoaded", () => this.load())
        : this.load();
  }
  disconnectedCallback() {
    var t = Disclosure.instances.indexOf(this);
    -1 < t && Disclosure.instances.splice(t, 1);
  }
  load() {
  ...
  updateFormListeners() {
    new ResizeObserver(() => this.updateFormPosition()).observe(document.body),
      this.closest('.drawer--side[data-side="left"]') &&
        window.on("theme:drawer:left:opened.Disclosure", () =>
          this.updateFormPosition()
        ),
      this.closest('.drawer--side[data-side="right"]') &&
        window.on("theme:drawer:right:opened.Disclosure", () =>
          this.updateFormPosition()
        );
  }
  showFormWhenClick() {
    this.toggle.off("click.Disclosure keydown.Disclosure"),
      this.toggle.on("click.Disclosure keydown.Disclosure", (t) => {
        if ("keydown" !== t.type || "Enter" === t.key) {
          t.preventDefault();
          const e = "true" === this.toggle.getAttribute("aria-expanded");
          Disclosure.instances.forEach((t) =>
            t === this ? this.toggleFormDisplay(!e) : t.toggleFormDisplay(!1)
          );
        }
      });
  }
  hideFormWhenFocusOut() {
    this.off("keydown.Disclosure focusout.Disclosure"),
      this.on("focusout.Disclosure", ({ relatedTarget: t }) => {
        this.form.contains(t) || this.toggleFormDisplay(!1);
      }),
      this.on("keydown.Disclosure", ({ key: t }) => {
  ...
  setOptionOnClick() {
    this.links.off("click.Disclosure keydown.Disclosure"),
      this.links.on(
        "click.Disclosure keydown.Disclosure",
        ({ key: t, type: e, target: i }) => {
          ...
          var s = i.dataset.value,
            ...
            o = i.getAttribute("data-product-url"),
            a = i.innerHTML;
          this.toggleFormDisplay(!1),
            (this.current_option.innerHTML = a),
            ...
            this.input.setAttribute("data-product-url", o),
  ...
  updateFormPosition() {
    (this.toggle_pos = this.offset()),
      this.updateFormYPosition(),
      "option-picker" !== this.type && this.updateFormXPosition();
  }
  updateFormYPosition() {
    var t = this.viewport ? this.viewport.offsetHeight : 0,
      e =
        this.form.offsetHeight +
        this.toggle_and_form_gap +
        this.window_and_form_gap,
      i = this.toggle_pos.top,
      s = t - i - this.toggle.offsetHeight;
    this.form.style.top =
      s < e && s < i
        ? `-${this.form.offsetHeight + this.toggle_and_form_gap}px`
        : this.toggle.offsetHeight + this.toggle_and_form_gap + "px";
  }
  updateFormXPosition() {
    var t =
        (this.viewport ? this.viewport.offsetWidth : 0) - this.toggle_pos.left,
      e = this.form.offsetWidth + this.window_and_form_gap;
    this.form.style.right =
      t <= e
        ? this.toggle.offsetWidth + this.window_and_form_gap - t + "px"
        : "unset";
  }
  optionChangeCallback() {
    this.input.off("change.Disclosure"),
      this.input.on("change.Disclosure", ({ target: t }) => {
...
class EditorEvents {
  ...
  sectionListeners() {
    document.on("shopify:section:load", ({ target: t }) => {
      Transitions.load();
      var e = t.querySelector("[data-section-id]");
      e &&
        (console.log(
          "Event 'theme:section:load' triggered by ." + e.classList[0]
        ),
        "function" == typeof e.trigger) &&
        e.trigger("theme:section:load");
    }),
      document.on("shopify:section:unload", ({ target: t }) => {
        var e = t.querySelector("[data-section-id]");
        e &&
          (console.log(
            "Event 'theme:section:unload' triggered by ." + e.classList[0]
          ),
          "function" == typeof e.trigger) &&
          e.trigger("theme:section:unload");
      }),
      document.on("shopify:section:select", ({ target: t }) => {
        var e = t.querySelector("[data-section-id]");
        e &&
          (console.log(
            "Event 'theme:section:select' triggered by ." + e.classList[0]
          ),
          "function" == typeof e.open
            ? e.open()
            : "function" == typeof e.trigger &&
              e.trigger("theme:section:select"));
      }),
      document.on("shopify:section:deselect", ({ target: t }) => {
        var e = t.querySelector("[data-section-id]");
        e &&
          (console.log(
            "Event 'theme:section:deselect' triggered by ." + e.classList[0]
          ),
          "function" == typeof e.close
            ? e.close()
            : "function" == typeof e.trigger &&
              e.trigger("theme:section:deselect"));
      }),
      document.on("shopify:section:reorder", ({ target: t }) => {
        var e = t.querySelector("[data-section-id]");
        e &&
          (console.log(
            "Event 'theme:section:reorder' triggered by ." + e.classList[0]
          ),
          "function" == typeof e.trigger) &&
          e.trigger("theme:section:reorder");
      }),
      document.on("shopify:block:select", ({ target: t }) => {
        console.log(
          "Event 'theme:block:select' triggered by ." + t.classList[0]
        ),
          "function" == typeof t.open
            ? t.open()
            : "function" == typeof t.trigger && t.trigger("theme:block:select");
      }),
      document.on("shopify:block:deselect", ({ target: t }) => {
        console.log(
          "Event 'theme:block:deselect' triggered by ." + t.classList[0]
        ),
          "function" == typeof t.close
            ? t.close()
            : "function" == typeof t.trigger &&
              t.trigger("theme:block:deselect");
      });
  }
}
new EditorEvents();
class ElementRelocator extends HTMLElement {
  ...
  connectedCallback() {
    ...
    (this.element_to_move_into = document.querySelector("" + t)),
      (this.element_to_move = this.querySelector(":scope > *")),
  ...
  moveElement() {
    (this.element_to_move_into.innerHTML = ""),
      this.element_to_move_into.appendChild(this.element_to_move);
  }
}
...
class Header extends HTMLElement {
  ...
  connectedCallback() {
    (this.primary_nav = this.querySelector(".header--primary-nav")),
      ...
      (this.sticky = "true" === this.getAttribute("data-sticky")),
  ...
  resizeObserver() {
    new ResizeObserver(() => {
      (this.root_rect = this.getBoundingClientRect()),
        this.scrollCallback(),
  ...
  checkHorizontalOverflow() {
    ...
    switch (this.layout) {
      case "center-left":
        this.enableOverlap(t);
        var e = this.primary_nav.getBoundingClientRect()["right"],
          i = this.logo.getBoundingClientRect()["left"];
        t = i < e + 16;
        break;
      case "left-center":
      case "left-left":
        t = this.minimum_expanded_width > this.container.offsetWidth;
        break;
      case "center-below":
        this.enableOverlap(t),
          (t = this.container.offsetWidth < this.primary_nav.offsetWidth + 64);
    }
  ...
  measureHeight() {
    (this.hide_offset = (
      this.root_rect.top +
      window.scrollY +
      this.root_rect.height
    ).toFixed(2)),
      document.documentElement.style.setProperty(
        "--header--height",
        this.root_rect.height.toFixed(2) + "px"
      );
  }
  scrollListener() {
    window.on(
      "scroll.Header",
      () => {
        this.animation_request && cancelAnimationFrame(this.animation_request),
  ...
  scrollCallback() {
    ...
    Drawer.status.includes("clos") &&
      ...
      this.root_rect &&
      ((t = window.scrollY),
      this.setAttribute("data-sticky", this.root_rect.top < t),
      this.scroll_hide) &&
      (t <= this.hide_offset
        ? (this.setAttribute("aria-hidden", !1),
  ...
  addShopifyListeners() {
    document.on("shopify:inspector:activate.Header", () => {
      ...
      document.on("shopify:section:load shopify:section:unload", () => {
        (this.root_rect = this.getBoundingClientRect()), this.measureHeight();
      }),
      ...
      this.on("theme:section:load", () => {
        Drawer.loadTriggers(), this.measureHeight();
      });
  }
}
...
class ImageComparisonSection extends HTMLElement {
  ...
  cursorListeners() {
    ...
    const e = "vertical" === this.direction && t;
    this.cursor.on(
      ...
      window.on(
        "mouseup touchend",
        () => {
          (this.cursor.style.cursor = "unset"),
            (Utils.disable_swipe_listener = !1),
            this.toggleText(!0);
        },
        { passive: !0 }
  ...
  moveCursor(t) {
    let e,
      i =
        ("horizontal" === this.direction
          ? (e = ("touchmove" === t.type ? t.targetTouches[0] : t).pageX)
          : "vertical" === this.direction &&
            (e = ("touchmove" === t.type ? t.targetTouches[0] : t).pageY),
        ((100 * (e - this.offset)) / this.total).toFixed(2));
    95 < i ? (i = 95) : i < 5 && (i = 5), this.setCursor(i);
  }
}
...
class MainProductCarousel extends Carousel {
  ...
  onSlideFinishedListener() {
    const i = this.querySelectorAll(".product-media--root");
...
class MasonryGrid extends HTMLElement {
  ...
  loadMasonry() {
    ...
    "small" !== SizeQueries.instances[window] &&
      window.Masonry &&
      ((t = "." + this.childNodes[0].classList[0]),
      (this.masonry = new Masonry(this, {
        itemSelector: t,
        percentPosition: !0,
        horizontalOrder: !0,
        columnWidth: t,
        gutter: this.dataset.gap ? parseInt(this.dataset.gap) : 0,
  ...
  resizeListener() {
    window.on("theme:mqs:updated", () => {
      "small" === SizeQueries.instances[window] || this.masonry
        ? "small" === SizeQueries.instances[window] &&
          this.masonry &&
          this.unloadMasonry()
        : this.loadMasonry();
...
class Navigation extends HTMLElement {
  ...
  load() {
    this.initGrid(),
      ...
      Shopify.designMode && Drawer.loadTriggers();
  }
  initGrid() {
  ...
  initNavigation() {
    (this.active_price_tag = this.querySelector(
      ...
      (this.local_storage_name =
        Shopify.theme.name + ":" + this.getAttribute("data-storage-name")),
  ...
  menuToggleListeners() {
    this.menu_toggles.on("click keydown", (t) => {
      if ("keydown" !== t.type || "Enter" === t.key) {
        var e = t.target;
        const i = "true" !== e.getAttribute("aria-expanded"),
          s = (e.setAttribute("aria-expanded", i), e.nextElementSibling);
        setTimeout(() => s.setAttribute("data-transition-active", i), 0);
      }
    });
  }
  clearAllListener() {
  ...
  browseListener() {
    this.browse_links.on("click keydown", (i) => {
      if ("keydown" !== i.type || "Enter" === i.key) {
        const s = i.target.previousElementSibling;
        let t = !1,
          e;
        s.checked && (t = !0),
          setTimeout(() => {
            (e = t
              ? ((s.checked = !1), Shopify.routes.all_products_collection)
              : s.value),
              (location.href = "" + location.origin + e),
  ...
  sortListener() {
    this.sort_links.on("click keydown", (e) => {
        ...
        s.checked && (t = !0),
          setTimeout(() => {
            t
              ...
              : ((s.checked = !0),
                (this.current_sort_link = i),
                (this.current_sort_label = s.dataset.label),
                (this.current_sort_value = s.value)),
  ...
  async getGridHtml() {
    ...
    try {
      ...
      this.renderGridHtml(t),
        ...
        setTimeout(() => this.loadTransitions(), 0),
  ...
  loadTransitions() {
    ...
    ].map((t) => Transitions.load(t)),
      Transitions.reload(this.body.parentNode.getAttribute("data-section-id"));
  }
  renderActiveSort() {
  ...
  renderActiveRefines() {
    ...
    const i = { labels: [], names: [], swatches: [], values: [] };
    if (
      (this.filter
...
class PasswordPage extends HTMLElement {
  ...
  connectedCallback() {
    (this.login_form = this.querySelector(".password--login-form")),
      ...
      (this.login_input = this.login_form.querySelector(
        'input[type="password"]'
      )),
  ...
  loginFormListener() {
    this.login_link.on("click keydown", (t) => {
      ("keydown" === t.type && "Enter" !== t.key) ||
        (t.preventDefault(),
        this.setAttribute("data-show-login", !0),
        this.login_input.focus());
    });
  }
  cancelLoginListener() {
    this.login_cancel.on("click keydown", (t) => {
      ("keydown" === t.type && "Enter" !== t.key) ||
...
class Placeholder extends HTMLElement {
  ...
  connectedCallback() {
    this.querySelectorAll("path").forEach((t) => {
...
class PriceRange extends HTMLElement {
  ...
  priceRangeResizeObserver() {
    new ResizeObserver(() => this.getPriceRangeGeometry()).observe(
      this.price_range_line
    );
  }
  priceInputListeners() {
  ...
  priceRangeListeners() {
    this.price_range_buttons.on(
      "mousedown.priceRange touchstart.priceRange",
      (t) => {
        ...
        (t) => {
          this.drag_start &&
            (this.animation_request &&
              cancelAnimationFrame(this.animation_request),
            (this.animation_request = requestAnimationFrame(() =>
              this.getNewButtonPosition(t)
            )));
        },
        { passive: !0 }
      ),
      window.on(
        "mouseup.priceRange touchend.priceRange",
        () => {
          this.drag_start &&
            ((this.drag_start = !1),
            (Utils.disable_swipe_listener = !1),
            this.active_range_button.dataset.hasOwnProperty("maxPrice")
              ? ((this.prices.current_max = parseFloat(
                  this.prices.pending_max
                )),
                (this.price_inputs[1].value = this.prices.current_max))
              : ((this.prices.current_min = parseFloat(
                  this.prices.pending_min
                )),
                (this.price_inputs[0].value = this.prices.current_min)),
            this.getPriceRangePositions(),
            this.renderActivePrice(),
...
class ProductBuyButtons extends HTMLElement {
  ...
  connectedCallback() {
    (this.cart_type = this.getAttribute("data-cart-type")),
      (this.primary_button = this.querySelector(
  ...
  addToCartListener() {
    this.closest("form").on("submit", async (t) => {
      var e = t.target.querySelector("[name=quantity]"),
        i = Utils.getQuantity(this.dataset.id, this.input.dataset, e.value);
      if (
        (("drawer" !== this.cart_type && !1 !== i) ||
          (t.preventDefault(), t.stopPropagation()),
        i &&
          (this.primary_button.setAttribute("aria-busy", !0),
        ...
        try {
          await Cart.addItems(r, this.input.value),
            this.primary_button.setAttribute("aria-busy", !1),
            Drawer.open("right", "cart-drawer", this.primary_button);
        } catch (t) {
          throw (
            (this.primary_button.setAttribute("aria-busy", !1), new Error(t))
          );
        }
      }
    });
  ...
  updateView(t, e) {
    t
      ? (this.primary_button.removeAttribute("disabled"),
        (this.button_text.textContent = this.translations.add_to_cart),
        this.smart_button && this.smart_button.setAttribute("aria-hidden", !1))
      : (this.primary_button.setAttribute("disabled", !0),
        this.smart_button && this.smart_button.setAttribute("aria-hidden", !0),
        (this.button_text.textContent = e
...
class ProductCard extends HTMLElement {
  ...
  connectedCallback() {
    (this.swatch_data = {}),
      ...
      (this.product_url =
        Shopify.routes.root + "products/" + this.getAttribute("data-handle")),
      (this.swatch_option_position =
        "option" + this.getAttribute("data-swatch-option-position")),
      this.inputs.length &&
  ...
  async fetchVariantImages() {
    var t = await fetch(this.product_url + ".js");
    if (t.ok) {
      const { variants: e, images: r } = await t.json();
      e.forEach((e) => {
        var t, i, s;
        e.featured_image &&
  ...
  inputListener() {
    this.inputs.on("change", ({ target: t }) => {
      ...
      e &&
        ...
        (this.main_image.parentNode.href =
          this.product_url + "?variant=" + e.variant_id));
    });
  }
}
...
class ProductLowStock extends HTMLElement {
  ...
  updateListener() {
    window.on(
      `theme:product:${this.dataset.id}:variantChanged`,
      ({ detail: { variant: t } }) => {
        t && t.available ? this.update(t.inventory_quantity) : this.show(!1);
      }
    );
  }
  update(t) {
...
class ProductMedia extends HTMLElement {
  ...
  scrollToMedia(t) {
    ...
    this.scroll_enabled &&
      ...
      ((i =
        "" ===
        (e = document.documentElement.style.getPropertyValue("--sticky-offset"))
          ? 0
          : parseInt(e.replace("px", ""))),
      window.scrollTo({ top: t - i - 8, left: 0, behavior: "smooth" }));
  }
  updateMixedMedia(t) {
...
class ProductModel extends HTMLElement {
  ...
  eventListeners() {
    this.on("theme:section:load", () => this.loadModel()),
      this.on("pauseMedia", () => !!this.model && this.model.pause()),
      this.on("playMedia", () => !!this.model && this.model.play()),
      new ResizeObserver(() => this.trigger("pauseMedia")).observe(this);
  }
  loadModel() {
    this.model ||
      !Shopify.ModelViewerUI ||
      ("small" === SizeQueries.instances[window] && "desktop" === this.view) ||
      ("small" !== SizeQueries.instances[window] && "mobile" === this.view) ||
...
class ProductOptions extends HTMLElement {
  ...
  connectedCallback() {
    (this.current_product_url = this.getAttribute("data-product-url")),
      ...
      (this.is_product_page =
        "true" === this.section_root.getAttribute("data-product-page")),
    ...
    this.querySelectorAll('[data-item="disclosure"], [data-item="radio"]').on(
      ...
      async ({ target: t }) => {
        ...
        var e,
          ...
          s,
          r,
          o = this.generateCacheKey(this.current_options),
          a = t.getAttribute("data-product-url");
        let n;
        ProductOptions.variant_caches[o]
          ? (n = await ProductOptions.variant_caches[o])
          : ((n = await this.fetchData(a, this.current_options)),
            (ProductOptions.variant_caches[o] = n)),
          "" !== a && a != this.current_product_url
            ? ((e = n.firstChild),
              this.section_root.parentNode.replaceChild(e, this.section_root),
              this.is_quick_add && QuickAdd
                ? ((i = e.getAttribute("data-handle")) &&
                    (QuickAdd.forms[i] = e),
                  delete QuickAdd.forms[this.handle])
                : (Transitions.reload("viewport"),
                  Shopify.PaymentButton && Shopify.PaymentButton.init(),
                  this.is_product_page &&
                    history.replaceState({ path: a }, "", a)))
            : ((s = n.querySelector(".product-options--root")),
              (this.outerHTML = s.outerHTML),
              (r = JSON.parse(
                s.querySelector("[id*=variant-json]").textContent
              )),
              this.updateVariant(r || !1));
      }
    );
  }
  loadVariantObserver() {
  ...
  updateHistoryState(t) {
    ...
    t && (e += "?variant=" + t.id), history.replaceState({ path: e }, "", e);
  }
  editorListeners() {
    ...
    window.on(
      ...
      ({ detail: { variant: t } }) => {
        t.available && "shopify" === t.inventory_management
          ...
          : (t && "shopify" === t.inventory_management && t.available) ||
            this.removeOldForm();
      }
    );
  }
...
class ProductRecommendations extends HTMLElement {
  ...
  connectedCallback() {
    (this.block = this.closest('[data-block-type="complementary-products"]')),
  ...
  async load() {
    var t = await fetch(
      `${Shopify.routes.product_recommendations}?section_id=${this.intent}-products&limit=${this.max_products}&product_id=${this.product_id}&intent=` +
        this.intent
    );
    if (!t.ok) throw new Error(t.statusText);
    var e = (await t.text()).parse().querySelectorAll("[data-product-item]");
    if (e.length) {
      const i = new DocumentFragment();
      e.forEach((t) => i.append(t)),
        (this.container.innerHTML = ""),
        this.container.appendChild(i),
        this.setAttribute("aria-hidden", !1),
        Transitions.reload("related-products");
    } else this.block && this.setAttribute("aria-hidden", !0);
  }
}
...
class ProductUnavailableForm extends HTMLElement {
  ...
  connectedCallback() {
    (this.form_value = this.querySelector(".product-unavailable--value")),
  ...
  async sendRequest() {
    ...
    var t = await fetch(Shopify.routes.root + "contact", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        form_type: "contact",
        contact: { email: this.input.value, message: this.form_value.value },
      }),
    });
    if (t.redirected && !t.url.includes("contact_posted=true"))
      window.location.href = t.url;
    else {
      if (!t.ok) throw new Error(t.statusText);
      (this.input.value = ""),
        FeedbackBar.load("product-form"),
        this.setAttribute("aria-busy", !1),
  ...
  displayListener() {
    window.on(
      `theme:product:${this.dataset.id}:variantChanged`,
      ({ detail: { variant: t } }) => {
        this.setAttribute("aria-hidden", !t || t.available),
          t &&
            (this.form_value.value =
              this.form_value.value.split(":")[0] + ": " + t.name);
      }
    );
  }
}
const productUnavailableFormEl = customElements.get(
  "product-unavailable-element"
);
productUnavailableFormEl ||
...
class ProductVideo extends HTMLElement {
  ...
  loadPlyrVideo() {
    this.video ||
      ...
      ((this.video = new Shopify.Video(this.querySelector("video"), {
        iconUrl: "/cdn/shopifycloud/plyr/v2.0/shopify-plyr.svg",
  ...
  loadYoutubeVideo() {
    ...
    this.video ||
      this.skipVideo() ||
      !YT.Player ||
      ((t = this.querySelector(".product-video")),
      (e = this.getAttribute("data-video-id")),
      (this.video = new YT.Player(t, {
        videoId: e,
        events: {
          onReady: (t) => {
            this.on("pauseMedia", () => t.target.pauseVideo()),
              this.on("playMedia", () => t.target.playVideo());
          },
          onStateChange: (t) => {
            var e;
            0 === t.data && this.loop_enabled && t.target.seekTo(0),
              1 === t.data &&
                (e = document
                  .querySelectorAll(
                    ".product-model--root, .product-video--root"
                  ...
                  .not(this)).length &&
                e.forEach((t) => t.trigger("pauseMedia"));
          },
        },
      })),
      window.trigger("theme:product:mediaLoaded"));
...
class ProductZoom extends HTMLElement {
  ...
  connectedCallback() {
    this.updateGeometry(), this.resizeObserver(), this.mouseListeners();
  }
  updateGeometry() {
    var { offsetHeight: t, offsetWidth: e } = this,
      i = e * this.magnify,
      s = t * this.magnify;
    (this.enlarged_image.style.width = i + "px"),
      (this.x_ratio = (i - e) / e),
      (this.y_ratio = (s - t) / t);
  }
  resizeObserver() {
  ...
  mouseListeners() {
    this.on("mouseenter", () => (this.enlarged_image.style.display = "block")),
      this.on("mouseleave", () => (this.enlarged_image.style.display = "none")),
      this.on("mousemove", ({ pageX: t, pageY: e }) => {
        this.mousemove_request && cancelAnimationFrame(this.mousemove_request),
          (this.mousemove_request = requestAnimationFrame(() =>
            this.moveEnlargedImage(t, e)
          ));
      });
  }
  moveEnlargedImage(t, e) {
    var { left: i, top: s } = this.offset();
    this.enlarged_image.setStyles({
      left: (i - t) * this.x_ratio + "px",
      top: (s - e) * this.y_ratio + "px",
    });
  }
}
...
class RecentProductsSection extends HTMLElement {
  ...
  async renderProductItem(t) {
    ...
    i.ok &&
      ((e = (await i.text()).parse(".product-card--root")),
      this.fragment.prepend(e));
  }
  productsLoaded() {
    this.grid_container.prepend(this.fragment),
      Transitions.reload("recents"),
      this.grid_container.removeAttribute("style"),
      (this.spinner.style.display = "none");
  }
}
...
class ShopTheLookSection extends HTMLElement {
  ...
  connectedCallback() {
    (this.add = this.querySelector(".shop-the-look--add")),
      (this.hotspots = this.querySelectorAll(".shop-the-look--button")),
      (this.dots = this.querySelectorAll(".shop-the-look--dot")),
  ...
  transitionObserver() {
    new IntersectionObserver(
      ([{ isIntersecting: t }], e) => {
        t &&
          (this.products[0].setAttribute("data-transition-active", !0),
          this.products[0].setAttribute("aria-hidden", !1),
          this.style.setProperty(
            "--hotspot-animation",
            "var(--ping-animation)"
          ),
          setTimeout(
            () => this.style.setProperty("--hotspot-size", "100%"),
            1500
          ),
          e.disconnect());
      },
    ...
    this.add &&
      this.add.on("click", async () => {
        if (0 !== this.product_ids.length) {
          ...
          try {
            await Cart.addItems(t, ...this.product_ids),
              Drawer.open("right", "cart-drawer", this.add);
          } catch (t) {
            throw new Error(t);
          }
  ...
  buttonListener() {
    [...this.dots, ...this.hotspots].on(
      "click",
      ({ key: t, target: e, type: i }) => {
        if ("keydown" !== i || "Enter" === t) {
          const s = e.dataset.index;
          this.hotspots.forEach((t) => {
            t.setAttribute("data-transition-active", t.dataset.index === s);
          }),
            this.dots.forEach((t) => {
              t.setAttribute("aria-current", t.dataset.index === s);
            }),
            this.products.forEach((t) => {
              t.setAttribute("data-transition-active", t.dataset.index === s),
                t.setAttribute("aria-hidden", t.dataset.index !== s);
            });
        }
      }
    );
  ...
  blockListener() {
    this.hotspots.on("theme:block:select", ({ target: t }) =>
      t.trigger("click")
    );
  }
}
...
class SlideshowCarousel extends Carousel {
  ...
  load() {
    (this.auto_rotate = "true" === this.getAttribute("data-auto-rotate")),
      ...
      super.load(),
      this.auto_rotate && this.startAutoRotate();
  }
  disconnectedCallback() {
    this.auto_rotate &&
  ...
  updateActive(t = !1, e = !1) {
    this.auto_rotate && !e && this.startAutoRotate(), super.updateActive(t);
  }
  startAutoRotate() {
    this.auto_slide_timer && clearInterval(this.auto_slide_timer),
      1 < this.slide_count &&
        (this.auto_slide_timer = setInterval(() => {
          this.slideToNext(!0, !0),
            this.updateActiveDot(),
            this.setSliderHeight();
        }, 1e3 * this.rotate_frequency));
  }
  fadeSlides() {
    null !== this.active_blocks &&
  ...
  blockListener() {
    super.blockListener(),
      ...
      this.blocks.on("shopify:block:deselect." + this.section_id, () => {
        this.auto_rotate &&
          (this.setAttribute("data-auto-rotate", !0), this.startAutoRotate());
      });
  }
  blockCallback(t) {
    super.blockCallback(t),
      this.auto_slide_timer &&
...
class VideoComponent extends HTMLElement {
  ...
  connectedCallback() {
    (this.api = this.getAttribute("data-api")),
      ...
      "fill-available" === this.display_type && this.resizeObserver(),
      this.autoplay ? this.loadLibraries() : this.playButtonListeners();
  }
  resizeObserver() {
    new ResizeObserver(() => {
      var t = (this.offsetWidth / this.offsetHeight).toFixed(4);
  ...
  loadLibraries() {
    switch (this.api) {
      case "youtube":
        (window.onYouTubeIframeAPIReady = () =>
          window.trigger("theme:youtube:apiReady")),
          window.on("theme:youtube:apiReady", () =>
            this.addObserver(this.loadYoutube.bind(this))
          ),
      ...
      case "vimeo":
        Utils.scriptLoader("vimeo", Shopify.routes.libraries.vimeo, () => {
          this.addObserver(this.loadVimeo.bind(this));
        });
        break;
      case "plyr":
        Utils.linkLoader(
          ...
          Utils.scriptLoader("plyr", Shopify.routes.libraries.plyr, () => {
            this.addObserver(this.loadPlyr.bind(this));
          });
    }
  }
  addObserver(i) {
  ...
  loadVimeo() {
    void 0 !== Vimeo.Player &&
      ((this.vimeo = new Vimeo.Player(this.id + "-player", {
        id: this.video_id,
        autopause: 0,
      ...
      this.vimeo.ready().then(() => {
        this.showPlayer(),
          this.autoplay || this.vimeoEvents(),
          this.trigger("theme:video:loaded");
      }),
      Promise.all([
        this.vimeo.getVideoWidth(),
        this.vimeo.getVideoHeight(),
      ]).then(([t, e]) => this.setAspectRatio(e, t)),
      this.vimeo.play());
  }
  vimeoEvents() {
    this.vimeo.getDuration().then((t) => {
      this.vimeo.addCuePoint(t - 0.3, {});
    }),
      this.vimeo.on("cuepoint", () => {
        this.vimeo.setCurrentTime(0), this.vimeo.pause();
      });
  }
  loadYoutube() {
    var t, e;
    void 0 !== YT.Player &&
      (({ height: t, width: e } = new YT.Player(this.id + "-player", {
  ...
  loadPlyr() {
    ...
    void 0 === Shopify.Video ||
      this.autoplay ||
      ((t = this.video_wrapper.querySelector("video")).on("ready", () =>
        this.showPlayer()
      ),
      new Shopify.Video(t, {
        autoplay: !0,
    ...
    this.play_button &&
      this.play_button.on("click keydown", (t) => {
        ("keydown" === t.type && "Enter" !== t.key) ||
          (t.preventDefault(),
          this.loadLibraries(),
          setTimeout(() => this.setAttribute("data-loaded", !0), 400));
      });
  }
}
...
class XMenu extends HTMLElement {
  ...
  mouseListeners() {
    this.menu_links.on("mouseenter.XMenu", ({ target: t }) => {
      this.close_timer ? (this.pending_open = t) : this.openMenu(t);
    }),
      this.menu_links.on("mouseleave.XMenu", ({ relatedTarget: t }) => {
        this.contains(t)
          ? this.close_timer ||
            (this.close_timer = setTimeout(() => {
              this.pending_open
                ? this.openMenu(this.pending_open)
                : this.closeMenu(),
                this.resetTimer();
            }, 80))
          : (this.closeMenu(), this.resetTimer());
      }),
  ...
  focusListeners() {
    this.menu_links.on("focusin.XMenu", ({ target: t }) => this.openMenu(t)),
      ...
      this.menu_containers.on(
        "focusout.XMenu",
        ({ target: t, relatedTarget: e }) => {
          null !== t.closest(".x-menu--level-1--link") ||
  ...
  openMenu(t) {
    var e = t.nextElementSibling;
    this.open_menu && this.open_menu !== e
      ? this.closeMenu(!0)
      : this.open_menu &&
        this.open_menu === e &&
      ...
      this.open_menu.removeAttribute("style"),
      setTimeout(() => this.open_menu.setAttribute("aria-hidden", !1), 0);
  }
  closeMenu(t) {
    null !== this.open_menu &&
      ...
      t
        ? (this.findAndResetTransition(this.open_menu),
          this.open_menu.off("transitionend"),
          (this.open_menu.style.display = "none"),
          (this.open_menu = null))
        : this.open_menu.on(
            "transitionend",
            () => {
  ...
  findAndResetTransition(t) {
    var e, i, s;
    t &&
      ((e = t.querySelectorAll("[data-transition-item]")).length &&
        e.forEach((t) => {
          t.removeAttribute("style");
        }),
      (i = t.querySelector("[data-transition-container]"))) &&
      ((s = i.getAttribute("data-transition-container")), Transitions.reset(s));
  }
}
...
class yMenu extends HTMLElement {
  ...
  connectedCallback() {
    (this.back_links = this.querySelectorAll(".y-menu--back-link button")),
      (this.drawer = this.closest(".drawer--side")),
    ...
    this.regular_links.on("click.YMenu", ({ target: t }) => {
      ...
      this.back_links.on("click.YMenu", ({ target: t }) => {
        ...
        this.open_menu_button &&
          this.open_menu_button.setAttribute("aria-expanded", !1),
          this.closeSubMenu(e),
          this.drawer.scrollTo(0, 0);
      });
  }
  adjustHeight(t) {
    ...
    var i = this.offsetHeight,
      s = ((this.style.height = i + "px"), window.getComputedStyle(t).position);
    "absolute" === s &&
  ...
  openSubMenu(t) {
    var e = this.querySelector("#" + t);
    this.adjustHeight(e), (e.style.transform = "translateX(-100%)");
  }
  closeSubMenu(t) {
    var e = this.querySelector("#" + t),
      i = e.parentNode.closest("ul");
    this.adjustHeight(i), (e.style.transform = "translateX(0)");
  }
}
